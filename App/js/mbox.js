...
TNT.a.b = {
 ...
 "clientCode": "adobeinternalloganro",
 "serverHost": "adobeinternalloganro.tt.omtrdc.net",
 "mboxTimeout": 10000,
 ...
 "imsOrgId": "C7E057EB5489EC230A4C98A5@AdobeOrg",
...
mboxUrlBuilder = function(ob, pb) {
 ...
 this.pb = pb;
 this.qb = [];
 this.rb = function(u) { return u; };
 this.sb = null;
};


mboxUrlBuilder.prototype.addNewParameter = function (tb, V) {
 this.qb.push({name: tb, value: V});
 return this;
};
...
mboxUrlBuilder.prototype.addParameters = function(qb) {
 ...
 this.addParameter(qb[ub].substring(0, wb),
 qb[ub].substring(wb + 1, qb[ub].length));
 }
 return this;
};
...
mboxFactory = function(Lb, pb, Mb, Nb) {
 ...
 this.Qb = b.mboxIsSupportedFunction() &&
 ...
 this.cc = new mboxSession(this.Wb, C.E, H.E,
 b.sessionExpirationTimeout, this.Ub);
...
mboxFactory.prototype.update = function(x, qb) {
 ...
 if (!this.isDomLoaded()) {
 this.addOnLoad(function() { hc.update(x, qb); });
 return;
 }
...
mbox.prototype.load = function(qb) {
 ...
 var Hb = (qb && qb.length > 0) ?
 this.Hb.clone().addParameters(qb) : this.Hb;
 this.cd.fetch(Hb);
...
mboxCookieManager.prototype.setCookie = function(tb, V, nc) {
 if (typeof tb != 'undefined' && typeof V != 'undefined' &&
 typeof nc != 'undefined') {
 var yd = {};
 yd.name = tb;
...
mboxScPluginFetcher = function (pb, Ud) {
 this.pb = pb;
 this.Ud = Ud;
};


mboxScPluginFetcher.prototype.Vd = function (Hb) {
 Hb.setBasePath('/m2/' + this.pb + '/sc/standard');
 this.Wd(Hb);

 var Xd = TNT.a.c.B;
 var Yd =TNT.a.L.B;

 Hb.addParameter(Xd, Yd);

 return Hb.buildUrl();
};


mboxScPluginFetcher.prototype.Wd = function (Hb) {
 var Zd = [
...
mboxScPluginFetcher.prototype._d = function (tb, Hb) {
 var T = TNT.a.T;
 var V = this.Ud[tb];
 ...
 Hb.addParameter(tb, V);
};

mboxScPluginFetcher.prototype.cancel = function () {
};

mboxScPluginFetcher.prototype.fetch = function (Hb) {
 Hb.setServerType(this.getType());
 var u = this.Vd(Hb);
...
mboxLoadSCPlugin = function (Ud) {
 if (!Ud) {
 return null;
 }

 var ae = TNT.a.b.siteCatalystPluginName;
 var pb = TNT.a.b.clientCode;

 Ud["m_" + ae] = function (Ud) {
 var be = Ud.m_i(ae);
 ...
 if (ic) {
 var md = new mboxScPluginFetcher(this.pb, this.s);
 ic.setFetcher(md);
 ic.load();
 }
 };
 ...
 return this.Rb && mboxFactoryDefault.isEnabled();
 };

 be.de = function () {
 var x = this.ee();
 var Xc = document.createElement('DIV');
 return mboxFactoryDefault.create(x, [], Xc);
 };

 be.ee = function () {
 var fe = this.s.events && this.s.events.indexOf('purchase') != -1;
 return 'SiteCatalyst: ' + (fe ? 'purchase' : 'event');
 };
 };

 return Ud.loadModule(ae);
};
...
mboxVizTargetUrl = function(x ) {
 ...
 Hb.addParameter(c.A, yc.getTime() - ge);
...
TNT.a.ne = function(Ub, oe, pe) {
 return mboxGetPageParameter(oe) || Ub.getCookie(pe);
};
...
TNT.a.we = function() {
 ...
 window.mboxFactoryDefault = new mboxFactory(xe, pb, M, Nb);
